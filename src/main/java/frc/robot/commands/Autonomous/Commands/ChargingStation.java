...
public class ChargingStation extends CommandBase {
  ...
  public static Double ConvertValuesToFeet(double currentEncoderValue) {
    double encoderRotations = currentEncoderValue / 2048;
    double Feet;
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("Right Encoder Rotations", drivebase.ConvertEncoder(RightLead.getSelectedSensorPosition()));
